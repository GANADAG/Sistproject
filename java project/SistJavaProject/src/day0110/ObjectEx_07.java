...
{
	String name;//instance 멤버변수..반드시 생성을 한후 쓸수있다(생성 안하면 쓸 수 없음)
	static final String MESSAGE="Happy day";//스테틱멤버변수(클래스 변수),주로 상수 선언시 사용
	...
	public static void main(String[] args) 
	{
		...
		//MESSAGE="Nice day"; final이라 값 변경 안됨
